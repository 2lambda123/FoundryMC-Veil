...
//
// public class VeilASTTransformer extends ASTTransformer<VeilJobParameters,
// String> {
//
//     @Override
//     public String transform(RootSupplier rootSupplier, String input) {
//         TranslationUnit tree = this.parseTranslationUnit(rootSupplier,
//         input); VeilJobParameters parameters = this.getJobParameters();
//
//         for (ShaderModification modification : parameters.modifiers()) {
//             try {
//                 modification.inject(this, tree, parameters);
//             } catch (Exception e) {
//                 Veil.LOGGER.error("Failed to apply modification {} to shader
//                 instance {}. Skipping",
//                 parameters.modificationManager().getModifierId(modification),
//                 parameters.shaderId(), e);
//             }
//         }
//
